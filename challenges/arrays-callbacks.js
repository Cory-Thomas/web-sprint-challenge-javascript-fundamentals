...
*/
const displayNames = [];
zooAnimals.forEach( (item, i) => {
  displayNames[i] = `Name: ${item.animal_name}, Scientific: ${item.scientific_name}`;
}) 
...
zooAnimals.map( (item, i) => {
  lowCaseAnimalNames[i] = item.animal_name.toLowerCase();
});
console.log(lowCaseAnimalNames);

/* Request 3: .filter() 

The zoos are concerned about animals with a lower population count. Using filter, create a new array of objects called lowPopulationAnimals 
